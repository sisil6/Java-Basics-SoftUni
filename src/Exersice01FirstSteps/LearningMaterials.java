...
public class LearningMaterials {
    public static void main(String[] args)
    {
        ...
        double discountNumber = discountPercentage/ 100;

        double pensSum = pens * pensPrice;
        double markersSum = markers * markersPrice;
        double cleanerSum = cleaner * cleanerPrice;
        double materialsPrice = pensSum + markersSum + cleanerSum;
        double total = materialsPrice - (materialsPrice * discountNumber);
